...
export const destinationRecs: Record<string, DestRec[]> = {
  rishikesh: [
    {
      ...
      category: "hotel",
      subtitle: "Near Ram Jhula",
      price_label: "₹1,200 / night",
      rating: 4.4,
      reviews: 128,
      duration: null,
    },
    {
      ...
      name: "River Rafting",
      category: "activity",
      subtitle: "Marine Drive Rapids",
      price_label: "₹900 / person",
      rating: 4.6,
      reviews: 342,
      duration: "4 hrs",
    },
  ...
  goa: [
    {
      ...
      category: "hotel",
      subtitle: "2 mins from the sand",
      price_label: "₹1,500 / night",
      rating: 4.5,
      reviews: 210,
      duration: null,
    },
    ...
    },
    {
      ...
      name: "Thalassa",
      category: "restaurant",
      subtitle: "Greek cliffside dining",
      price_label: "₹1,200 for two",
      rating: 4.5,
      reviews: 890,
      duration: null,
    },
  ...
  manali: [
    {
      id: "mn1",
      name: "Old Manali Pine Stay",
      category: "hotel",
      subtitle: "Riverside wooden cabin",
      price_label: "₹1,900 / night",
      rating: 4.5,
      reviews: 174,
      duration: null,
    },
    {
      ...
      category: "activity",
      subtitle: "Tandem flight",
      price_label: "₹2,500 / person",
      rating: 4.6,
      reviews: 388,
      duration: "1 hr",
    },
    {
      ...
      category: "attraction",
      subtitle: "From Vashisht village",
      price_label: "Free",
      rating: 4.7,
      reviews: 142,
      duration: "3 hrs",
    },
    {
      ...
      name: "Cafe 1947",
      category: "restaurant",
      subtitle: "Live music by the river",
      price_label: "₹800 for two",
      rating: 4.4,
      reviews: 512,
      duration: null,
    },
  ...
  jaipur: [
    {
      ...
      category: "hotel",
      subtitle: "Walled city, near Hawa Mahal",
      price_label: "₹2,200 / night",
      rating: 4.6,
      reviews: 199,
      duration: null,
    },
    {
      ...
      category: "activity",
      subtitle: "Evening sound & light",
      price_label: "₹300 / person",
      rating: 4.5,
      reviews: 268,
      duration: "1 hr",
    },
    ...
    },
    {
      ...
      name: "LMB Restaurant",
      category: "restaurant",
      subtitle: "Classic Rajasthani thali",
      price_label: "₹600 for two",
      rating: 4.4,
      reviews: 742,
      duration: null,
    },
  ...
  kerala: [
    {
      ...
      category: "hotel",
      subtitle: "Private backwater cruise",
      price_label: "₹7,500 / night",
      rating: 4.8,
      reviews: 302,
      duration: null,
    },
    {
      ...
      category: "activity",
      subtitle: "Sunrise plantation trail",
      price_label: "₹600 / person",
      rating: 4.7,
      reviews: 188,
      duration: "2 hrs",
    },
    {
      ...
      category: "attraction",
      subtitle: "Nilgiri tahr spotting",
      price_label: "₹200",
      rating: 4.6,
      reviews: 421,
      duration: "3 hrs",
    },
    {
      ...
      category: "restaurant",
      subtitle: "Kerala parotta & beef fry",
